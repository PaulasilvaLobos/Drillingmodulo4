from clases import Vehículo, Automóvil, Bicicleta, Particular, Carga, Motocicleta
...
print("Motocicleta es instancia con relación a Vehículo:", isinstance(motocicleta, Vehículo))
print("Motocicleta es instancia con relación a Automovil:", isinstance(motocicleta, Automóvil))
